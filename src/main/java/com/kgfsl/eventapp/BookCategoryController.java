...
public class BookCategoryController {
  ...
  @PostMapping("/post")
  public @ResponseBody ResponseEntity<?> post(@RequestBody BookCategory bookCategory, UriComponentsBuilder ucBuilder) {
  ...
  public ResponseEntity<?> delete(@PathVariable Long bookcatId) {
      //bookCategory currentbookCategory = bookCategoryService.find(bookCategoryId);
